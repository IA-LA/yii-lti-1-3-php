    ...
    <div>
        ...
        <?php if (Yii::$app->session->hasFlash('publishIsPosible')): ?>
            ...
            <?php
                ...
                print_r($output);
                echo "10.PassThru" . $output = passthru('git -C uploads/publicacion/' . $namedir . '/ pull origin master 2>&1') . "<br/>";
                print($output);
                echo "</pre></p>";
                ...
                if(($retval === 0) || (!strpos($output, "Merge made by the 'recursive' strategy."))) {
                    echo 'STRPOS=' . strpos($output, "Merge made by the 'recursive' strategy.", 0);
            ?>
