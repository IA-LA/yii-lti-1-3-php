    ...
    <div>
        ...
        <?php if (Yii::$app->session->hasFlash('publishIsPosible')): ?>
            ...
            <?php
                ...
                //print_r($output);
                exec('git -C uploads/publicacion/' . $namedir . '/ pull origin master 2>&1', $output, $retval);
                ...
                echo "10.PassThru" . passthru('git -C uploads/publicacion/' . $namedir . '/ pull origin master 2>&1', $retval) . "<br/>";
                //print($retva);
                //echo "</pre></p>";
                shell_exec(escapeshellcmd('$(git -C uploads/publicacion/' . $namedir . '/ pull origin master)'));
                //echo "<pre>10.b. $output</pre>";
                system(escapeshellcmd('$(git -C uploads/publicacion/' . $namedir . '/ pull origin master)'), $retval);
