        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'update-form']); ?>
                    ...
                    <?= $form->field($model, 'private_key_file')->hint(['value' => isset($private_key_file)? $private_key_file : ' ']) ?>
                    <?= $form->field($model, 'kid')->hint(['value' => isset($kid)? $kid : ' ']) ?>
                    <?= $form->field($model, 'deployment')->textInput(['value' => isset($deployment)? $deployment : ' ']) ?>
                    <?= $form->field($model, 'auth_server')->hint(['value' => isset($auth_server)? $auth_server : ' ']) ?>
