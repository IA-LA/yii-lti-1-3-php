        ...
        'items' => [
            ...
            ['label' => Yii::$app->user->isGuest ? ('Tools') : ('Tools (' . Yii::$app->user->identity->username . ')'),
                'items' => Yii::$app->user->isGuest ? ([]) : ([
                    ...
                    '<ul style="list-style-type:none">',
                    ['label' => 'Delete', 'url' => ['/crud/Upload/delete']],
                    ['label' => 'Lists', 'url' => ['/crud/Upload/lists']],
                    ['label' => 'Query', 'url' => ['/crud/Upload/query']],
                    ['label' => 'Register', 'url' => ['/crud/Upload/register']],
                    ['label' => 'Register', 'url' => ['/crud/Upload/update']],
                    '</ul>',
                    '<li class="divider"></li>',
                    '<li class="dropdown-header">LTI Menu</li>',
                    '<ul style="list-style-type:none">',
                    ['label' => 'Delete', 'url' => ['/crudl/ti/delete']],
                    ['label' => 'Lists', 'url' => ['/crud/lti/lists']],
                    ['label' => 'Query', 'url' => ['/crud/lti/query']],
                    ['label' => 'Register', 'url' => ['/crud/lti/register']],
                    ['label' => 'Register', 'url' => ['/crud/lti/update']],
                    '</ul>',
                    '<li class="divider"></li>',
                    '<li class="dropdown-header">Platform Menu</li>',
                    '<ul style="list-style-type:none">',
                    ['label' => 'Delete', 'url' => ['/crudplatform/delete']],
                    ['label' => 'Lists', 'url' => ['/crudplatform/lists']],
                    ['label' => 'Query', 'url' => ['/crudplatform/query']],
                    ['label' => 'Register', 'url' => ['/crudplatform/register']],
                    ['label' => 'Register', 'url' => ['/crudplatform/update']],
                    '</ul>',
                ]),
            ],
