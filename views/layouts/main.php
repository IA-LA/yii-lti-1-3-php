        ...
        'items' => [
            ...
            ['label' => Yii::$app->user->isGuest ? ('Tools') : ('Tools (' . Yii::$app->user->identity->username . ')'),
                'items' => Yii::$app->user->isGuest ? ([]) : ([
                    ...
                    ['label' => 'Lists', 'url' => ['/crudupload/lists']],
                    ['label' => 'Query', 'url' => ['/crudupload/query']],
                    ['label' => 'Register', 'url' => ['/crudupload/register']],
                    ['label' => 'Register', 'url' => ['/crudupload/update']],
                    '</ul>',
                    '<li class="divider"></li>',
                    '<li class="dropdown-header">LTI Menu</li>',
                    '<ul style="list-style-type:none">',
                    ['label' => 'Delete', 'url' => ['/crudlti/delete']],
                    ['label' => 'Lists', 'url' => ['/crudlti/lists']],
                    ['label' => 'Query', 'url' => ['/crudlti/query']],
                    ['label' => 'Register', 'url' => ['/crudlti/register']],
                    ['label' => 'Register', 'url' => ['/crudlti/update']],
                    '</ul>',
                    '<li class="divider"></li>',
