        ...
        <div>
            ...
            ?>
                ...
                <?php
                        ...
                        // GET
                        ////////////////////////////////
                        echo '<p class="alert alert-success"><div class="row"><div class="col-lg-6">Puede registrarse esta actividad con el ID: <i>`' . $namedir . '`</i> y la dirección URL: ´<b><a href="uploads/publicacion/' . $namedir . '" target="_blank">' . $namedir . '</a></b>´.</div>' .
