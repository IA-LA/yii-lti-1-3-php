    ...
    <?php if (Yii::$app->session->hasFlash('uploadFormSubmitted')): ?>
        ...
        <div>
            ...
            <?php
                    ...
                    echo "<p><pre>7.a.a. PassThru " . passthru('git -C uploads/publicacion/' . $namedir . '/ add . 2>&1') . "<br/>";
                    print_r($output);
                    //echo "</pre></p>";
                    ...
                    echo "<p><pre>9.a.b. PassThru " . passthru('git -C uploads/publicacion/' . $namedir . '/ reset 2>&1') . "<br/>";
                    print_r($output);
                    //echo "</pre></p>";
