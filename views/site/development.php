...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <div class="row">
            ...
            print_r($output);
            echo "8.a.PassThru " . passthru('unzip uploads/600ff7059d5e4d1174e7c425_5e46670337ebc61534f37c4a_5e46673e37ebc61534f37c4d.zip -d uploads/publicacion/' . $namedir . ' 2>&1') . "<br/>";
            echo "</pre></p>";
