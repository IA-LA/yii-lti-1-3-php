...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <div class="row">
            ...
            echo "<p><pre>8.a.<br/>";
            echo "8.a.PassThru " . passthru('git -C uploads/publicacion/' . $namedir . ' config --global user.email "you@example.com" 2>&1') . "<br/>";
            print_r($output);
            echo "</pre></p>";
            // outputs the username that owns the running php/httpd process
            // (on a system with the "git add" executable in the path)
            ...
            echo "8.Returned with status $retval and output:\n";
            echo "<p><pre>8.b.<br/>";
            echo "8.b.PassThru " . passthru('git -C uploads/publicacion/' . $namedir . ' config --global user.name "Your Name" 2>&1') . "<br/>";
            print_r($output);
            echo "</pre></p>";
