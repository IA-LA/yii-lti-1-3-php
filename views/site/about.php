...
-->
    <div class="body-content">
        ...
        <ol>
            ...
            <li><del><samp>DONE</samp></del> Registrar automáticamente ID + URL de la Actividad (eContent) publicada en el Servidor LTI</li>
            <li><del><samp>DONE</samp></del> Registrar automáticamente ZIP + URL y Proyecto Git de la Upload en el Servidor LTI</li>
            <li><del><samp>DONE</samp></del> Proveer <a href="http://ailanto-dev.intecca.uned.es:9002/login.php?iss=10120210421153903000000a&login_hint=123456&target_link_uri=https://ailanto-dev.intecca.uned.es/lti/publicacion/10120210421153903000000a&lti_message_hint=123456" target="_blank">una Actividad LTI</a> (<a href="https://ailanto-dev.intecca.uned.es/lti/publicacion/10120210421153903000000a" target="_blank">eContent</a>) en entornos LMS (<a href="http://ailanto-dev.intecca.uned.es:18010/container/block-v1:edX+DemoX+Demo_Course+type@vertical+block@7a2650b00f89411792c3ab18fa631aa5" target="_blank">EdX</a>, <a href="https://ailanto-dev.intecca.uned.es/eTrivial/course/view.php?id=52#section-0" target="_blank">Moodle</a>, etc) HTTP</li>
            <li><code>TODO</code> Proveer una Actividad LTI (<a href="">eContent</a>) en entornos LMS (EdX, Moodle, etc) HTTPS</li>
            <li><del><samp>DONE</samp></del> Proveer <a href="https://lti-ri.imsglobal.org/platforms/2630/resource_links/62041" target="_blank">un Recurso</a> (LtiResourceLinkRequest) <a href="https://lti-ri.imsglobal.org/platforms/2630/resource_links/62041/rosters" target="_blank">vía OIDC</a> en plataformas <a href="https://lti-ri.imsglobal.org/platforms/2630" target="_blank">IMS Global</a> simuladas</li>
            <li><code>TODO</code> Proveer un Recurso (LtiResourceLinkRequest) <a href="">vía OIDC en plataformas</a> <a href="http://ailanto-dev.intecca.uned.es:8080" target="_blank">EDX</a>, etc reales</li>
            <li><code>TODO</code> Paso mensajes (DeepLinkingRequest DL) en plataformas <a href="https://lti-ri.imsglobal.org/platforms/2630" target="_blank">IMS Global</a> simuladas</li>
            <li><code>TODO</code> Paso mensajes (DeepLinkingRequest DL) en plataformas <a href="http://ailanto-dev.intecca.uned.es:8080" target="_blank">EDX</a>, etc reales</li>
            <li><code>TODO</code> Paso mensajes (AGS) en plataformas <a href="http://ailanto-dev.intecca.uned.es:8080" target="_blank">EDX</a>, etc reales</li>
            <li><code>TODO</code> Paso mensajes (NPRS) en plataformas <a href="http://ailanto-dev.intecca.uned.es:8080" target="_blank">EDX</a>, etc reales</li>
        </ol>
        <div class="row">
            <div class="col-lg-4">
                <h2>Main Menu</h2>
