...
<div class="site-uploadregister">
    ...
    <?php if (Yii::$app->session->hasFlash('uploadregisterFormSubmitted')): ?>
        ...
        <?php
                        ...
                        // REGISTRO
                        ////////////////////////////////
                        echo '<p><div class="row alert alert-success">La actividad LTI ha quedado registrada con el ID: <b><i>`' . $namedir . '`</i></b> y la dirección URL: ´<b><i><a href="uploads/publicacion/' . $namedir . '" target="_blank">' . $namedir . '</a></i></b>´.</div>' .
