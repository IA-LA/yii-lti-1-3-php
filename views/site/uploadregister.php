...
<div class="site-uploadregister">
    ...
    <?php if (Yii::$app->session->hasFlash('uploadregisterFormSubmitted')): ?>
        ...
        <?php
                        ...
                        // REGISTRO
                        ////////////////////////////////
                        echo '<p><div class="row alert alert-success"><ol><li>La actividad LTI ha quedado registrada con el ID: <b><i>`' . $namedir . '`</i></b> y la dirección URL: ´<b><i><a href="uploads/publicacion/' . $namedir . '" target="_blank">' . $namedir . '</a></i></b></ol></li>´.' .
                            //'<div class="col-lg-2"><a class="btn btn-lg btn-primary" href="index.php?r=site%2Fregister">Registrar LTI</a></div></div>'.
                            '<div class="row alert alert-success"><ol><li>El Upload ha sido registrado con el ID: <b><i>`' . $namedir . '`</i></b>, el fichero: ´<b><i><a href="uploads/' . $file . '" target="_blank">' . $file . '</a></i>´</b>, la carpeta `<b>' . $namedir . '</b>`, la dirección de publicación: ´<b><i><a href="uploads/publicacion/' . $namedir . '" target="_blank">' . $namedir . '</a></i></b>´ y el proyecto Git: ´<b><i><a href="uploads/git/' . $namedir . '.git" target="_blank">' . $namedir . '.git</a></i></b>´.</ol></li></p>' .
