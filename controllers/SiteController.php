...
class SiteController extends Controller
{
    ...
    public function actionRegister()
    {
        ...
        if ($model->load( $model->register(Yii::$app->params['adminEmail'])) {
            ...
            return $this->renderContent('<div><p/><p/><p/><p class="alert alert-success"> Registro finalizado: ' . ArrayHelper::isAssociative($request) . '<br/>REQUEST:<br/> . print_r($request) . <br/>RESPONSE:<br/> . print_r($response)' . ArrayHelper::getValue($response, 'result') . '</p></div>');
            //return $this->refresh();
        }
