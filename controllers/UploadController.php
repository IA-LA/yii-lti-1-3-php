                        ...
                        if(!array_key_exists('_id', $response->data['data'])) {
                            ...
                            foreach ($response->data['data'] as $index => $value){
                                ...
                                $responseItem = [
                                    ...
                                    'image' => 'http://placehold.it/300x200',
                                    'buttonC' => '<button class="btn btn-lg btn-outline-primary" style="height: 10px;width:25px;">Create</button>',
                                    'buttonR' => '<button class="btn btn-lg btn-info">Readte</button>',
                                    'buttonU' => '<button class="btn btn-lg btn-warning">Update</button>',
                                    'buttonD' => '<button class="btn btn-lg btn-danger">Delete</button>'
                                ];
