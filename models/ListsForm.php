...
class ListsForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['id', 'match', 'pattern'=>"/^(.*)|([a-f0-9]{1:23}[*])|([*][a-f0-9]{1:23})|([*][a-f0-9]{1:22}[*])|([*])$/u", 'message'=>'Has to be a valid Mongo ObjectId hexadecimal 24 character address like this: `5fc3860a81740b0ef098a965` or using the wildcard * to list all registers in this way: *, HH..HH*, *HH..HH, *HH..HH*.'],
