...
class ListsForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['id', 'match', 'pattern'=>"/^([a-f0-9]{24})|([a-f0-9]{0:23})[*]{1}|\*([a-f0-9]{0:23})|[*]{1}([a-f0-9]{0:22})|[*]{1}$/u", 'message'=>'Has to be a valid Mongo ObjectId hexadecimal 24 character address like this: `5fc3860a81740b0ef098a965` or with the wildcard * to list all registers in that way: *, HH..HH*, *HH..HH, *HH..HH*.'],
