        ...
        if($retval === 0) {
            ...
            //      /ruta/fichero.zip
                ...
                if($retval === 0) {
                    ...
                    // REGISTER Publicación & Actividad LTI
                    // --------------------------
                    ...
                    if ($namefile !== '') {
                        ...
                        $ruta = '/create/coleccion/Lti/url_actividad/' . str_replace('+', '%20', urlencode($serverPub . '/' . $namedir));
                    }
                    ...
                    if ($response->isOk && $response->data['result'] === 'ok' && $response->data['data']['result'] === 'Existe') {
                        ...
                        $content = '<div><p/><p/><p/>';
                        $content .= '<p class="alert error-summary"> Registro: ' . 'error' . '</p>';
