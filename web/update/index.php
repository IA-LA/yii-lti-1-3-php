...
<div class="upload-uploadregister">
                ...
                if($retval === 0) {
                    ...
                    if($retval === 0) {
                        ...
                        if($retval === 0) {
                            ...
                            //print_r($output);
                            //echo "</pre></p>";
                            exec(escapeshellcmd('git -C ../uploads/publicacion/' . $namedir . '/ rm -r --cached "*" -f -q '), $output, $retval);
                            ...
                            if(false && ($arrayFileGet!==false) && ($arrayFileGet!=='')){
    ...
    <?php else: ?>
        ...
        <p>
            Formulario de actualización o subida de Econtent complejos desde el GICCU.
